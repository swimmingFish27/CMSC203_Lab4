...
public class TwoDimArrayPractice extends JFrame
{
   ...
   */
   public void setValues( int value, int row )
   {
    ...
    //  and column is the index of the array's current column
    // Write your code here:
	   System.out.print("......Set Value for row " + row + " with value = " + value + ".........");
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   ...
	   for (int i=0; i< intArray.length; i++) {
		   if (minInt > intArray[i][column]) {
			   minInt = intArray[i][column];
			   animate( i, column, minInt);
		   }
	   }
    ...
    // Write your code here:
	   ...
	   for (int i =0; i < intArray.length; i++) {
		   for(int x =0; x< intArray[i].length; x++) {
			   ...
			   animate( i, x, countInt);
		   }
	   }

     return countInt; // replace this line with your return statement
   }
